...
def get_forward_lstm_model(load_from_file=True):
    ...
    if not load_from_file:
        ...
        print("\nForward")
        train(trajpredictor_forward, optimizer_forward, loss_fn, epochs=150)
        print("\n")
...
def get_backward_lstm_model(load_from_file=True):
    ...
    if not load_from_file:
        ...
        print("\nBackward")
        train(trajpredictor_backward, optimizer_backward, loss_fn, epochs=150, backward_model=True)
        print("\n")
